...
public class Book_released extends javax.swing.JFrame {
    ...
    public void SELECT() {
        ...
        Integer q = 0;
        String[] Data_Stolb= {"ID выданной книги","ID копии книги которая выданна", "ID читателя", "дата взятия", "на сколько взята","дата возврата книги"};
    ...
    public void INSERT(){
        nom1=1;//нужно для UPDATE_readers
        //делаються поля
        String[] Data_Stolb= {"ID копии книги которая выданна", "ID читателя", "на сколько взята","дата возврата книги"};
    ...
    public void UPDATE(){
        ...
        String[] Data_Stolb= {"ID выданной книги для изменения", "на сколько взята","дата возврата книги"};
