 ...
 * @author User
 */
public class book_authors extends javax.swing.JFrame {
    //счетчик
    Integer s = 0;
    ...
    public void Not_Zokritie() {
        setDefaultCloseOperation(book_authors.DISPOSE_ON_CLOSE);
    }
    ...
    public void SELECT() {
        ...
        Integer q = 0;
        String[] Data_Stolb= {"ID книги","ID автора"};
        
        //SELECT COUNT(*) FROM "readers", кол-во строк
        try (Connection conn = getConnection();
            Statement stmt = conn.createStatement()) {
            String Select_readersN = "SELECT COUNT(*) FROM \"public\".\"book_authors\"";
        ...
        try (Connection conn = getConnection();
        Statement stmt = conn.createStatement()) {
            Select = "SELECT * FROM \"public\".\"book_authors\" ORDER BY \"book_id\" ASC";
    ...
    public void INSERT(){
        ...
        String author_id = (String) jTable1.getValueAt(0, 1);

        try (Connection conn = getConnection();
        Statement stmt = conn.createStatement()){
            if(nom==2){
                //сам запрос
                String ins = "INSERT INTO \"public\".\"book_authors\""  
                    + "(book_id, author_id)" 
    ...
    public void UPDATE(){
        ...
        String[] Data_Stolb= {"ID книги для изменения","ID автора"};
        ...
        Statement stmt = conn.createStatement()){
            if(nom1==2){
                //сам запрос
                String ins = "UPDATE public.book_authors " +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(book_authors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
