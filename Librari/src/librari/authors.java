...
public class authors extends javax.swing.JFrame {
    ...
    String Select = "SELECT * FROM \"public\".\"authors\" ORDER BY \"author_id\" ASC";
    String SelectN = "SELECT COUNT(*) FROM \"public\".\"authors\"";
    ...
    public void Not_Zokritie() {
        setDefaultCloseOperation(authors.DISPOSE_ON_CLOSE);
    }
    ...
    public void SELECT() {
        ...
        Integer q = 0;
        String[] Data_Stolb= {"author_id","Фамилия", "Имя", "Отчество"};
        
        //SELECT COUNT(*) FROM "readers", кол-во строк
        try (Connection conn = getConnection();
            Statement stmt = conn.createStatement()) {
            String Select_readersN = "SELECT COUNT(*) FROM \"public\".\"authors\"";
        ...
        try (Connection conn = getConnection();
        Statement stmt = conn.createStatement()) {
            Select = "SELECT * FROM \"public\".\"authors\" ORDER BY \"author_id\" ASC";
    ...
    public void INSERT(){
        nom1=1;//нужно для UPDATE_readers
        //делаються поля
        String[] Data_Stolb= {"Фамилия", "Имя", "Отчество"};
        ...
        String first_name = (String) jTable1.getValueAt(0, 0);
        String middle_name = (String) jTable1.getValueAt(0, 1);
        String last_name = (String) jTable1.getValueAt(0, 2);

        try (Connection conn = getConnection();
        Statement stmt = conn.createStatement()){
            if(nom==2){
                //сам запрос
                String ins = "INSERT INTO \"public\".\"authors\""  
    ...
    public void UPDATE(){
        ...
        //переменные для в вода
        String author_id = (String) jTable1.getValueAt(0, 0);
        String first_name = (String) jTable1.getValueAt(0, 1);
        String middle_name = (String) jTable1.getValueAt(0, 2);
        String last_name = (String) jTable1.getValueAt(0, 3);
        
        try (Connection conn = getConnection();
        Statement stmt = conn.createStatement()){
            if(nom1==2){
                //сам запрос
                String ins = "UPDATE public.authors " +
