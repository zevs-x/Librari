...
public class staff extends javax.swing.JFrame {
    ...
    //переменная для INSERT
    Integer nom=1;
    
    //переменная для UPDATE
    Integer nom1=1;
    //данные для БД
    ...
    public void SELECT_staff() {
        ...
        Integer q = 0;
        String[] Data_Stolb= {"staff_id", "Фамилия", "Имя", "Отчество", "Дата рождения","Роль"};
    ...
    public void INSERT_staff(){
        nom1=1;//нужно для UPDATE
        //делаються поля
        String[] Data_Stolb= {"Фамилия", "Имя", "Отчество", "Дата рождения", "Роль"};
    ...
    public void UPDATE_staff(){
        nom=1;//нужно для INSERT
        String[] Data_Stolb= {"ID сотрудника для изменения", "Фамилия", "Имя", "Отчество", "Роль"};
